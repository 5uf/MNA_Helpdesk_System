...
<head>
    ...
    <!-- Title Page-->
    <title>Your Report Submitted</title>
...
$time=date(" d/m/Y - h:i A");
?>
<body class="animsition" onload="decrement()">
  <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light" style="height: 4.7em;" id="collapse">  
    ...
    <div class="card" style="margin-left: 35%; margin-top: 5%; border: thin solid green; border-radius:10%; height: 20em;">
        ...
        <div class="row justify-content-md-center">
            <form><h4 style="font-family: times new roman;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Redirecting to ANM in <input type="text" size="3" id="timer" name="redirect2" value="5"></h4></form>
        </div>
        <div class="row justify-content-md-center">
       <div class="card-body">
        ...
        <h5>Telah Dihantar Ke Sekyen Teknologi Maklumat</h5>
    </div>
            </div>
         </div>
    </div>
